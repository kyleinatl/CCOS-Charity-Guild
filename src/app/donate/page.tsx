  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-sky-100">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-blue-200">
                  <th className="text-left py-4 px-4 text-blue-900 font-bold text-lg">Diamond Patron</th>
                  <th className="text-left py-4 px-4 text-blue-900 font-bold text-lg">Platinum Patron</th>
                  <th className="text-left py-4 px-4 text-blue-900 font-bold text-lg">Gold Patron</th>
                  <th className="text-left py-4 px-4 text-blue-900 font-bold text-lg">Silver Patron</th>
                  <th className="text-left py-4 px-4 text-blue-900 font-bold text-lg">Hope</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="py-4 px-4 text-blue-800 font-semibold text-lg">$10,000+</td>
                  <td className="py-4 px-4 text-blue-800 font-semibold text-lg">$5,000</td>
                  <td className="py-4 px-4 text-blue-800 font-semibold text-lg">$1,000</td>
                  <td className="py-4 px-4 text-blue-800 font-semibold text-lg">$500</td>
                  <td className="py-4 px-4 text-blue-800 font-semibold text-lg">$100</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* Member Privileges */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-blue-100 mb-8">
          <h3 className="text-2xl font-bold text-blue-900 mb-4">Member privileges include:</h3>
          <ul className="space-y-2 mb-6">
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">•</span>
              <span className="text-lg text-blue-800">Full participation in charity selection process</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">•</span>
              <span className="text-lg text-blue-800">Invitations to Guild-sponsored events</span>
            </li>
          </ul>
          
          <h3 className="text-2xl font-bold text-blue-900 mb-4 mt-8">Exclusive Patron privileges:</h3>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-sky-600 rounded-2xl p-8 shadow-xl border border-blue-200 mb-6">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-blue-100">
          <h3 className="text-2xl font-bold text-blue-900 mb-6">Donate from a Trust or Pay by Check</h3>
