...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-sky-100 animate-fadeIn">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              />
              <div>
                <h1 className="text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent">
                  Country Club of the South
                </h1>
                <p className="text-xs sm:text-sm text-blue-600 font-medium">Charity Guild</p>
              </div>
            </div>
            <a
              href="/"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-blue-100 mb-8">
          <h3 className="text-2xl font-bold text-blue-900 mb-4">Inquiries</h3>
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-2 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-blue-600 to-sky-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-sky-700 transition-all shadow-lg hover:shadow-xl"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-blue-100">
          <h3 className="text-2xl font-bold text-blue-900 mb-6">Executive Board</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {boardMembers.map((member, index) => (
              <div key={index} className="border-l-4 border-blue-600 pl-4">
                <h4 className="font-semibold text-blue-900 mb-2">{member.title}</h4>
                <div className="space-y-1">
                  {member.names.map((name, nameIndex) => (
                    <p key={nameIndex} className="text-blue-700">
                      {name}
                    </p>
                  ))}
                </div>
