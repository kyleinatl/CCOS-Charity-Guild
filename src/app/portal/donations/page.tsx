...
function MemberDonations() {
  ...
  if (!donationsData) {
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          <p className="text-muted-foreground">Failed to load donation data</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(summary.totalDonated)}</div>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(summary.averageDonation)}</div>
            <p className="text-xs text-muted-foreground">
              Per donation
            </p>
          </CardContent>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className="text-lg font-bold">{formatDate(summary.lastDonation)}</div>
            <p className="text-xs text-muted-foreground">
              Most recent
            </p>
          </CardContent>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-semibold text-gray-900">{donation.campaign}</h4>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {donationsData.yearlyStats.map((stat: any) => (
              <div key={stat.year} className="p-4 bg-gray-50 rounded-lg">
